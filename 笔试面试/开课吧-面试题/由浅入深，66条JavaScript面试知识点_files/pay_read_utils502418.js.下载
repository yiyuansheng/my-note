...
function m(){
dn.mylist.children.length?(l(dn.mylist.parentNode),Bn||"none"===dn.mine.style.display||_t.removeClass(document.body,kn)):(d(dn.mylist.parentNode),
Bn||"none"===dn.mine.style.display||_t.addClass(document.body,kn));
}
function r(){
var e=0,t=dn.mylist.getElementsByClassName("js_comment_item");
...
function c(){
var e=dn.mylist.getElementsByClassName("js_comment_item");
if(e&&e.length)for(var t=0;t<e.length;t++){
var n=e[t];
l(n);
for(var o=n.getElementsByClassName("js_reply_item"),i=0;i<o.length;i++)l(o[i]);
var d=n.getElementsByClassName("js_reply_div").length>0?n.getElementsByClassName("js_reply_div")[0]:null;
d&&l(d);
}
yn=!0;
}
function _(e){
dn.el_alertContent.innerHTML=e,dn.el_alertPanel.style.display="";
}
function p(){
...
function u(e){
var t=a(e,dn.mylist),n=t?750:2e3;
...
function w(e){
var t=e.actiontype,n=void 0===t?0:t,o=e.personalCommentId,i=void 0===o?0:o,l=e.num,d=void 0===l?0:l;
Ht.report(19462,_extends({
PersonalCommentId:parseInt(i,10)||0,
CommentId:parseInt(Zt,10)||0,
actiontype:n,
wording:"余下N条",
number:parseInt(d,10)||0,
devicetype:Bn?1:2
},Ut));
}
function h(){
...
function j(){
try{
var e=dn.loading.getBoundingClientRect(),t=Math.random()<1;
...
function v(){
var e=dn.showAll,t=jt.getScrollTop(),n=Lt.getY(e,"js_article");
...
function I(){
s(dn.expandAndFoldPC)&&(b(1),It.off(window,"scroll",I));
}
function B(e){
var t=(new Date).getTime(),n=new Date;
n.setDate(n.getDate()+1),n.setHours(0),n.setMinutes(0),n.setSeconds(0),n=n.getTime();
var o=t/1e3-e,i=n/1e3-e,l=new Date(n).getFullYear(),d=new Date(1e3*e);
return 3600>o?Math.ceil(o/60)+"分钟前":86400>i?Math.floor(o/60/60)+"小时前":172800>i?"昨天":604800>i?Math.floor(i/24/60/60)+"天前":d.getFullYear()===l?d.getMonth()+1+"月"+d.getDate()+"日":d.getFullYear()+"年"+(d.getMonth()+1)+"月"+d.getDate()+"日";
}
function E(e){
...
function T(e,t,n){
var o=void 0,i=void 0,l="",d="",a=!Jt&&!pn||Jt&&Gt||pn&&un,s=document.createElement("div");
"elected"===n?d=0:"friend"===n&&(d=1),cn={};
...
i.report_elected=i.is_elected||0,i.report_friend=i.is_from_friend||0,i.scene=d,i.supportReply=Tn&&i.is_from_me&&a&&!In,
...
i.replyListCount=m,i.new_appmsg=window.new_appmsg,l+=Et.tmpl(pt,i,!1);
try{
...
for(s.innerHTML=l,E(s);s.children.item(0);)o=s.children.item(0),t.appendChild(o);
}
function x(e){
...
offset:$t,
url:bn
}))),1!==i.enabled?(xn&&(xn.style.display="none"),Pn&&d(Pn),i.elected_comment=[],
...
if(T(t,m,"elected"),s&&(dn.list.innerHTML=""),dn.list.appendChild(m),l(dn.main),
In||(pn&&0===un?(document.getElementById("js_cmt_nofans1").innerHTML="作者已设置关注3天后才可留言",
l(document.getElementById("js_cmt_nofans1"),"block")):Jt&&0===i.is_fans?(document.getElementById("js_cmt_nofans1").innerHTML="作者已设置关注后才可以留言",
l(document.getElementById("js_cmt_nofans1"),"block")):Rt&&(Bn?(l(dn.commentPC),l(dn.inputPC)):l(dn.addCmtBtn1))),
i.elected_comment_total_cnt<=10&&(l(document.getElementById("js_cmt_statement")),
l(document.getElementById("js_cmt_qa"))),!Xt&&"5"===window.item_show_type){
...
}else d(dn.main),pn&&0===un?(document.getElementById("js_cmt_nofans2_inner").innerHTML="作者已设置关注3天后才可留言",
l(document.getElementById("js_cmt_nofans2"),"block")):Jt&&0===i.is_fans?(document.getElementById("js_cmt_nofans2_inner").innerHTML="作者已设置关注后才可以留言",
l(document.getElementById("js_cmt_nofans2"),"block")):Rt&&(Bn?(l(dn.commentPC),l(dn.inputPC)):l(dn.addCmtBtn2));
n=i.friend_comment,T(n,r,"friend"),n&&0===n.length&&d(Pn),s&&(dn.fdlist.innerHTML=""),
dn.fdlist&&dn.fdlist.appendChild(r),n&&n.length?(l(dn.fdmain),(!Jt||Jt&&1===i.is_fans)&&(Bn||(d(dn.addCmtBtn1),
d(dn.addCmtBtn2),Rt&&l(dn.addCmtBtn3)))):d(dn.fdmain);
...
}else t=i.elected_comment,t&&t.length&&(T(t,m,"elected"),dn.list.appendChild(m));
0===i.elected_comment_total_cnt?($t=-1,d(document.getElementById("js_cmt_loading")),
d(document.getElementById("js_cmt_statement")),d(document.getElementById("js_cmt_qa"))):$t+vn>=i.elected_comment_total_cnt?($t=-1,
d(document.getElementById("js_cmt_loading")),l(document.getElementById("js_cmt_statement")),
l(document.getElementById("js_cmt_qa"))):$t+=i.elected_comment.length,window.ipados13_font_scale&&Mt.setFontSize(dn.main,window.ipados13_font_scale/100);
var p=5;
if(window.user_uin%2===0&&(p=8),t.length>p&&window.has_related_article){
var u=0;
l(dn.showAll),d(document.getElementById("js_cmt_statement"));
for(var g=dn.list.querySelectorAll("li.js_comment_item"),w=0;p>w;w++){
...
dn.listContainer.style.height=u+"px",dn.showAllWording.innerText="查看更多%s条留言".replace("%s",t.length-p);
var j=function(){
if("none"!==dn.showAll.style.display){
for(var e=0,t=dn.list.querySelectorAll("li.js_comment_item"),n=0;p>n;n++){
...
dn.listContainer.style.height=e+"px";
}
};
window.addEventListener("resize",j),window.ipados13_font_scale&&(Mt.setFontSize(dn.showAllWording,window.ipados13_font_scale/100),
...
en=!0,d(dn.tips),l(dn.loading);
try{
on++,t&&(ln=[]),on>1&&!t&&f(Wt.moreList,encodeURIComponent(a)),ln.indexOf(a)>-1&&f(Wt.repeatList,encodeURIComponent(a)),
ln.push(a);
}catch(m){
console.error(m);
}
...
complete:function(){
en=!1,d(dn.loading),It.off(window,"scroll",j);
}
});
}
}
...
function A(){
2>=gn?d(dn.expandAndFoldPC):(l(dn.expandAndFoldPC),yn?(_t.addClass(dn.expandAndFoldPC,"comment_primary_more_access_unfold"),
dn.expandAndFoldPC.innerHTML="收起我的留言"):(_t.removeClass(dn.expandAndFoldPC,"comment_primary_more_access_unfold"),
dn.expandAndFoldPC.innerHTML="展开我的留言"));
}
function S(){
dn.list.children.length?dn.fdlist.children.length?(Rt&&l(dn.addCmtBtn3),d(dn.addCmtBtn1),
d(dn.addCmtBtn2),d(dn.addCmtBtn4)):(Rt&&l(dn.addCmtBtn1),d(dn.addCmtBtn2),d(dn.addCmtBtn3),
d(dn.addCmtBtn4)):dn.fdlist.children.length?(Rt&&l(dn.addCmtBtn3),d(dn.addCmtBtn4),
d(dn.addCmtBtn1),d(dn.addCmtBtn2)):(Rt&&l(dn.addCmtBtn2),d(dn.addCmtBtn3),d(dn.addCmtBtn1),
d(dn.addCmtBtn4)),Bn&&(d(dn.addCmtBtn1),d(dn.addCmtBtn2),d(dn.addCmtBtn3));
}
function H(e,t){
...
p(),T([o],n,"mine"),dn.mylist.insertBefore(n,dn.mylist.firstChild),m(),Bn?(dn.input.innerHTML="",
dn.inputHolder.style.display="",dn.containerPC.style.display="none",dn.inputPC.style.display="",
gn++,yn=!0,wn.unshift(o),c(),A()):dn.input.value="",S();
}
function L(e,t){
...
function M(e,t,n,o){
u(o),dn.input.innerHTML="",dn.inputHolder.style.display="",gn++;
var i=document.createDocumentFragment(),l=document.getElementById("cid"+t),s=l.nextSibling;
dn.mylist.removeChild(l);
var m=L(t,wn);
...
uin:Ft,
reply_id:e.reply_id
}),a(o,dn.list)?(d(dn.containerPC),T([m],i,"mine"),dn.mylist.insertBefore(i,s),yn?c():r()):(T([m],i,"mine"),
dn.mylist.insertBefore(i,s),yn=!0,c())),A();
}
function N(e){
var t=dn.containerPC.getAttribute("data-my-id"),n=g(sn).replace(/<br\/>/g,"").replace(/\n/g,"")||"",o=document.getElementById("activity-name");
if(dn.submit.disabled!==!0){
if(n.length<1)return void _("留言不能为空");
if(n.length>600)return void _("字数不能多于600个");
dn.submit.disabled=!0;
...
if(n=Bn?g(sn).replace(/<br\/>/g,"").replace(/\n/g,"")||"":g(dn.input.value),Pt.log("tag2"),
!_t.hasClass(dn.submit,"btn_disabled")&&dn.submit.disabled!==!0){
if(Pt.log("tag3"),n.length<1)return void _("留言不能为空");
if(Pt.log("tag4"),n.length>600)return void _("字数不能多于600个");
Bn&&(n=sn),Pt.log("tag5"),Bn?dn.submit.disabled=!0:_t.addClass(dn.submit,"btn_disabled"),
Pt.log("tag6");
...
complete:function(){
""!==dn.input.value&&_t.removeClass(dn.submit,"btn_disabled");
}
});
}
}
...
function z(e){
D(e),r(),gn>2&&(dn.expandAndFoldPC.innerHTML="展开我的留言",l(dn.expandAndFoldPC),yn=!1,
b(1));
}
function F(){
...
o&&o.length&&(Bn&&(l(dn.myareaPC),l(dn.mylist)),T(o,i,"mine"),dn.mylist.appendChild(i),
Bn&&z(o)),rn=2;
...
function W(e){
return Kt=jt.getScrollTop(),O()&&e?void q():(Bn||d(dn.article),l(dn.mine),dn.deletePanel=document.getElementById("js_delete_panel_mobile"),
dn.deleteConfirm=document.getElementById("js_delete_confirm_mobile"),dn.deleteCancel=document.getElementById("js_delete_cancel_mobile"),
window.__second_open__&&yt.os.ios&&l(dn.fakebar),window.scrollTo(0,0),F(),void(e||Pt.later(function(){
dn.input.focus();
})));
}
function G(){
...
function Y(){
d(dn.mine),l(dn.article),dn.deletePanel=document.getElementById("js_delete_panel"),
dn.deleteConfirm=document.getElementById("js_delete_confirm"),dn.deleteCancel=document.getElementById("js_delete_cancel"),
window.scrollTo(0,Kt),dn.input.blur(),_t.removeClass(document.body,En),_t.removeClass(document.body,kn);
}
function V(e){
...
for(var o=parseInt(n.dataset.status,10),i=0===o?1:0,l=n.dataset.contentId,d=n.dataset.scene,a=document.querySelectorAll('.js_comment_praise[data-content-id="'+l+'"]'),s=0;s<a.length;s++)V(a[s]);
if(ft({
...
function J(e){
for(var t=e.delegatedTarget,n=parseInt(t.dataset.status,10),o=n?0:1,i=t.dataset.contentId,l=t.dataset.replyId,d=t.dataset.scene,a=document.querySelectorAll('.js_reply_praise[data-content-id="'+i+'"][data-reply-id="'+l+'"]'),s=0;s<a.length;s++)V(a[s]);
if(Bt({
...
e.reply_id===parseInt(l,10)&&(e.reply_like_status=o,e.reply_like_num=o?e.reply_like_num++:e.reply_like_num--);
});
}
}
function X(e,t){
e.parentNode.removeChild(e),_t.addClass(dn.deletePanel,"weui-transition_opacity-hide");
for(var n=document.querySelectorAll(".cid"+t),o=0;o<n.length;o++)n[o].parentNode.removeChild(n[o]);
if(dn.list.children.length?dn.fdlist.children.length||d(dn.fdmain):(d(dn.main),d(document.getElementById("js_cmt_statement")),
d(document.getElementById("js_cmt_qa")),dn.fdlist.children.length||d(dn.fdmain)),
m(),S(),Bn){
var i=L(t,wn);
...
function Z(e){
var t=void 0,n=e.delegatedTarget,i=n.getAttribute("data-my-id"),l=ht.join("/mp/appmsg_comment",{
action:"delete",
scene:Wt.scene,
appmsgid:window.appmsgid,
my_id:i,
...
_t.removeClass(dn.deletePanel,"weui-transition_opacity-hide"),It.on(dn.deleteConfirm,"click",function(){
t!==i&&(t=i,Bt({
url:l,
dataType:"json",
success:function(e){
...
l(dn.deleteReplyPanel),It.on(dn.deleteReplyConfirm,"click",function(){
t!==a&&(t=a,Bt({
url:s,
dataType:"json",
success:function(e){
...
}),It.on(dn.deleteReplyCancel,"click",function(){
t!==a&&(t=a,d(dn.deleteReplyPanel));
});
}
function et(){
dn.input.innerHTML="",dn.input.focus(),Cn=null,dn.submit.disabled=!0;
}
function tt(e){
...
reply_content:s
}),!0):(Bn?(dn.containerPC.parentNode.removeChild(dn.containerPC),i.appendChild(dn.containerPC),
dn.containerPC.setAttribute("data-my-id",n),dn.inputHolder.innerHTML="留言的回复被公众号精选后，将对所有人可见",
dn.inputHolder.style.display="",dn.submit.innerText="回复",d(dn.emotionPanel),"none"===dn.inputPC.style.display&&l(dn.inputPC),
l(dn.containerPC),et(),fn=!0):(l(dn.updateDialog),Nt.setSum(110809,51,1),It.on(dn.updateCancel,"click",function(){
d(dn.updateDialog);
}),It.on(dn.updateConfirm,"click",function(){
Nt.setSum(110809,52,1),St.isIOS?At.jumpUrl(Nn,!0):St.isAndroid&&At.jumpUrl(Rn,!0);
})),!1);
}
function nt(e){
for(var t=e.delegatedTarget||e.srcElement,n=t.getAttribute("data-my-id"),o=dn.list.querySelectorAll('.reply_result[data-my-id="'+n+'"]'),i=dn.list.querySelectorAll('.js_reply_div[data-my-id="'+n+'"]'),a=t.getAttribute("data-num"),s=0;s<o.length;s++)l(o[s]);
1===i.length&&l(i[0]),d(t),w({
actiontype:2,
personalCommentId:n,
num:a
});
...
function ot(e){
e&&e.preventDefault(),Y(),d(dn.fakebar);
}
function it(e,t){
...
function st(){
It.on(dn.input,"input",function(e){
if(Bn){
var t=dn.input.innerHTML;
""===t||"<br>"===t?(dn.inputHolder.style.display="",dn.input.innerHTML=""):dn.inputHolder.style.display="none";
}
var n=g(dn.input.value||dn.input.innerHTML);
n.length<1?_t.addClass(dn.submit,"btn_disabled"):_t.removeClass(dn.submit,"btn_disabled"),
yt.os.ios&&e.data&&Mn.indexOf(e.data)>-1&&(nn=!0);
}),It.on(dn.input,"click",function(){
yt.os.ios&&nn&&(dn.input.blur(),dn.input.focus(),nn=!1);
}),It.on(dn.el_alertConfirm,"click",function(){
dn.el_alertPanel.style.display="none";
}),Bn&&It.on(dn.input,"click",function(){
d(document.getElementById("js_emotion_panel_pc"));
}),It.on(dn.list,"click",".js_comment_praise",Q),It.on(dn.mylist,"click",".js_comment_praise",Q),
It.on(dn.fdlist,"click",".js_comment_praise",Q),It.on(dn.list,"click",".js_reply_praise",J),
It.on(dn.fdlist,"click",".js_reply_praise",J),It.on(dn.mylist,"click",".js_reply_praise",J),
It.on(dn.list,"click",".js_del",Z),It.on(dn.mylist,"click",".js_del",Z),It.on(dn.fdlist,"click",".js_del",Z),
It.on(dn.mylist,"click",".js_reply_del",K),It.on(dn.list,"click",".js_reply_del",K),
It.on(dn.list,"click",".js_comment_reply",tt),It.on(dn.mylist,"click",".js_comment_reply",tt),
It.on(dn.list,"click",".js_extend_comment",nt),jt.listenMpPageAction(function(e){
...
try{
for(var l,d=t[Symbol.iterator]();!(n=(l=d.next()).done);n=!0){
var a=l.value;
...
}),It.on(dn.list,"click",".js_del",function(e){
e.preventDefault();
}),It.on(dn.mylist,"click",".js_del",function(e){
e.preventDefault();
}),It.on(dn.fdlist,"click",".js_del",function(e){
e.preventDefault();
}),It.on(dn.submit,"click",R),It.on(dn.submit,"click",function(e){
e.preventDefault();
}),dn.goback&&(It.on(dn.goback,"click",ot),It.on(dn.goback,"click",ot)),window.__second_open__&&yt.os.ios&&!function(){
It.on(dn.input,"click",function(){
d(dn.fakebar);
}),It.on(dn.input,"blur",function(){
"none"!==dn.mine.style.display&&l(dn.fakebar);
});
var e=null,t=null;
It.on(window,"orientationchange",function(){
"none"!==dn.fakebar.style.display&&(clearTimeout(e),e=setTimeout(function(){
window.innerWidth!==parseFloat(getComputedStyle(dn.fakebar).width)&&(clearTimeout(t),
dn.mine.style.height=jt.getInnerHeight()+"px",window.scrollBy&&window.scrollBy(0,1),
t=setTimeout(function(){
window.scrollBy&&window.scrollBy(0,-1),dn.mine.style.height="";
},100));
},50));
});
...
it(e);
}),It.on(dn.inputPC,"click",function(){
d(dn.inputPC),dn.containerPC.parentNode.removeChild(dn.containerPC),dn.inputHolder.style.display="",
dn.inputHolder.innerHTML="留言被公众号精选后，将对所有人可见",dn.submit.innerText="留言",document.getElementById("js_cmt_panel_pc").appendChild(dn.containerPC),
fn=!1,l(dn.containerPC),dt(dn.containerPC)&&lt(dn.containerPC),et();
}),It.bindVisibilityChangeEvt(function(e){
e&&jt.getScrollTop()<wt.getOffset(dn.cmtContainer).offsetTop-jt.getInnerHeight()&&P({
forceRefresh:!0,
cb:x
});
}),It.on(dn.showAllWording,"click",function(e){
e.preventDefault(),d(dn.showAll),l(document.getElementById("js_cmt_statement")),
dn.listContainer.style.height="auto",Ht.report(18832,_extends({
Actiontype:2,
Type:3,
Bizuin:0,
Msgid:0,
...
e.innerHTML=dn.input.innerHTML;
...
l=!0),i){
var d=l?document.createTextNode(i):i;
e.replaceChild(d,o);
...
function o(){
dn.input.focus(),dn.input.scrollTop=dn.input.scrollHeight,n();
}
function i(){
var e=g(sn).replace(/<br\/>/g,"").replace(/\n/g,"").length;
h.innerText=e,e>600?(w.style.display="",_t.addClass(w,"comment_primary_counter_warn"),
dn.submit.disabled=!0):1>e?(w.style.display="none",_t.removeClass(w,"comment_primary_counter_warn"),
dn.submit.disabled=!0):(w.style.display="none",_t.removeClass(w,"comment_primary_counter_warn"),
dn.submit.disabled=!1);
}
function s(e,t){
var n=["&#96;","`","&#39;","'","&quot;",'"',"&nbsp;"," ","&gt;",">","&lt;","<","&yen;","¥","&amp;","&"],o=["&","&amp;","¥","&yen;","<","&lt;",">","&gt;"," ","&nbsp;",'"',"&quot;","'","&#39;","`","&#96;"],i=void 0;
i=t?o:n;
for(var l=0;l<i.length;l+=2)e=e.replace(new RegExp(i[l],"g"),i[l+1]);
return e;
}
function m(){
...
var i=n.createContextualFragment(e),l=i.lastChild,d=vt.getSelection();
n.deleteContents(),n.insertNode(i),n.setStartBefore(l),n.setEndAfter(l),d.removeAllRanges(),
...
function u(){
for(var e=dn.input,t=void 0,n=e.childNodes.length-1;n>=0;n--){
var o=e.childNodes[n];
switch(o.nodeType){
case 1:
if("BR"!==o.nodeName.toUpperCase()){
...
dn.input&&"none"!==dn.input.display&&""!==dn.input.innerHTML&&dn.input.blur();
}),It.on(dn.input,"keyup",function(){
t(),m();
}),It.on(dn.input,"keydown",function(e){
return 13===e.keyCode?(t(),_("<br/>"),t(),!1):void 0;
}),It.on(dn.input,"mouseup",function(){
t(),m();
}),It.on(dn.input,"paste",function(){
...
if((!fn&&!a(t,dn.addbtnPC)||fn&&!a(t,dn.containerPC))&&"none"!==dn.containerPC.style.display){
var o=dn.input.innerHTML;
""===g(o)&&(d(dn.containerPC),l(dn.inputPC),d(n));
}
a(t,n)||a(t,dn.emotionSwitchPC)||"none"===n.style.display||d(n);
},!1),It.on(dn.expandAndFoldPC,"click",function(){
yn?(b(2),_t.removeClass(dn.expandAndFoldPC,"comment_primary_more_access_unfold"),
dn.expandAndFoldPC.innerHTML="展开我的留言",r(),yn=!1,b(1)):(b(2),_t.addClass(dn.expandAndFoldPC,"comment_primary_more_access_unfold"),
dn.expandAndFoldPC.innerHTML="收起我的留言",c(),yn=!0,b(1));
...
if(Pn){
var l=e("appmsg/friend_comment_tpl.html.js");
Pn.innerHTML=Et.tmpl(l,{
new_appmsg:window.new_appmsg
},!1);
}
var d="";
...
_t.addClass(document.body,"pages_skin_pc")):i("js_cmt_addbtn_pc"),dn={
...
},window.__second_open__&&yt.os.ios&&(dn.mine.style.marginBottom=getComputedStyle(dn.fakebar).height),
...
o.setAttribute("like",i.liked?"1":"0"),i.likeGray&&(n.disabled=!0));
